				...
				<div class="card-body">
		            <div class="form-group row">
						<div class="col-md-5 col-12 mb-1 mb-md-0">
							<input type="hidden" name="kel1[]" value="1">
	...
	if(typeof response.id != 'undefined') {
		...
		$.each(response.detail_ket,function(e,d){
			if(e == '0') {
				...
				$('#kodeinventaris').val(d.kode_inventaris);
				...
				$('#additional-anggota .kodeinventaris').last().val(d.kode_inventaris);
		...
		$.each(response.detail_invk2,function(e,d){
			if(e == '0') {
				...
				$('#additional-kel1 .catataninvkel2').last().val(d.catatan);
