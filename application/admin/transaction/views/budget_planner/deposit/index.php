...
<div class="content-body m-t-column">
	...
	<div class="row">
		<div class="col-sm-12 col-12">
			<br>
			<div class="card">
	    		<div class="card-header"><?php echo lang('deposit'); ?></div>
				<div class="row">
				...
				<div class="card-body">
						...
						table_open('table table-bordered table-app table-hover');
							thead();
								...
								<tr>
									...
									<th style="background-color: #e64a19; color: white;"><font color="#fff">Keterangan</font>
									<?php
									for ($i = 1; $i <= 12; $i++) { 
					...
					<br>
					<div class="card-header"><?php echo '>> Rincian Deposito Berdasarkan Suku Bunga (rate)'; ?></div>
							...
							thead();
								...
								<tr>
									...
									foreach ($detail_tahun as $d) {
										...
										echo '<th style="background-color: #e64a19; color: white;min-width:80px;"><font color="#fff">Prosentase</font></th>';
									?>
...
function save_perubahan() {
	...
	var jsonString = JSON.stringify(data_edit);		
	 $.ajax({
	 	url : base_url + 'transaction/deposit/save_perubahan',
	 	data 	: {
	 		'json' : jsonString,
	 		verifikasi : i
	 	},
