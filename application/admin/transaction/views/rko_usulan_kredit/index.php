...
modal_open('modal-form','','modal-lg','data-openCallback="formOpen"');
	modal_body();
		form_open(base_url('transaction/rko_usulan_kredit/save'),'post','form'); 
				col_init(2,4);
				input('hidden','id','id');
...
function getData() {
	...
	var page = base_url + 'transaction/rko_usulan_kredit/data';
...
function save_perubahan() {
	...
	$.ajax({
		url : base_url + 'transaction/rko_usulan_kredit/save_perubahan',
		data 	: {
			'json' : jsonString,
			verifikasi : i
		},
