		...
		<tr>
			<?php
				...
				switch ($m1->sumber_data) {
				  case 1:
				    $keterangan = 'TOTAL KREDIT ' . $m1->data_core;
				    break;
				  case 4:
				  ...
				  case 5:
				    ...
				    break;
				  default:
    				$keterangan = 'TOTAL KREDIT ' . $m1->data_core .' (Renc.)';
				} 
			...
			for ($i = 1; $i <= 12; $i++) { 
				...
				//	debug($GR04);die;
					...
					echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right" data-name="" data-value=""'.$m1->$v_field.'"">'.$field_v.'</div></td>';
			}
			?>
