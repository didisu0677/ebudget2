...
modal_open('modal-form','','modal-lg','data-openCallback="formOpen"');
	modal_body();
		form_open(base_url('transaction/usulan_dpk/save'),'post','form'); 
				col_init(2,4);
				input('hidden','id','id');
...
function getData() {
	...
	var page = base_url + 'transaction/usulan_dpk/data';
...
function save_perubahan() {
	...
	$.ajax({
		url : base_url + 'transaction/usulan_dpk/save_perubahan',
		data 	: {
			'json' : jsonString,
			verifikasi : i
		},
